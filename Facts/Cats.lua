...
Most world languages have a similar word to describe the “meow” sound.
Every Scottish Fold cat in the world can trace its heritage back to the first one, which was found in Scotland in the 1960s, says Cheryl Hogan, a Scottish Fold breeder and the committee chair for the breed at The International Cat Association (TICA).
Hissing is defensive, not aggressive, says Layla Morgan Wilde, a cat behavior expert and the founder of Cat Wisdom 101. “It’s an expression of fear, stress or discomfort of a threatened cat communicating ‘stay away,’” she says.
If cats are fighting, the cat that is hissing is the more vulnerable one, says Wilde.
When a cat flops over and exposes his belly, it’s not always an invitation for a belly rub. “This is probably the most common cause of people getting scratched by a cat,” Wilde says. A cat performs this action when he is relaxed and showing trust.
A housecat’s genome is 95.6 percent tiger, and they share many behaviors with their jungle ancestors, says Wilde. These behaviors include scent marking by scratching, prey play, prey stalking and pouncing, chinning and territorial scent and urine marking.
Cats have a unique “vocabulary” with their owner — each cat has a different set of vocalizations, purrs and behaviors.
If you can’t find your cat, you should look in a box or a bag, as these are some of their favorite hiding spots!
...
Cats do not have collarbones. Instead their front legs are attached to their shoulders with clavicle bones which are not attached directly to any other bones, instead, they float freely connected only by tendons and muscle. This allows your cat to easily squeeze through seemingly impossibly small spaces!
...
Spaying or neutering your pet kitty helps them live up to 62% longer. This is in part because in tom cats neutering lowers the likelihood of testicular cancer, prostate disease and hernias. Neutering also reduces testosterone levels which means your cat is less likely to get involved in dangerous fights.[15]
